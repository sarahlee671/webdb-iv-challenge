  ...
  return knex('recipe_ingredients').del()
    .then(function () {
      ...
      return knex('recipe_ingredients').insert([
        ...
        {recipe_id: 1, ingredient_id: 8, quantity: 9},
        ...
        {recipe_id: 5, ingredient_id: 18, quantity: 1},
        {recipe_id: 5, ingredient_id: 19, quantity: 3},
        {recipe_id: 6, ingredient_id: 13, quantity: 1},
        {recipe_id: 6, ingredient_id: 15, quantity: 4},
        {recipe_id: 7, ingredient_id: 12, quantity: 1},
        {recipe_id: 7, ingredient_id: 15, quantity: 4},
